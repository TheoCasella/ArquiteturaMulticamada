# Importamos a interface da pasta Dados (ajuste o caminho conforme sua estrutura)
from Dados.livro_repository import IRepositorioLivro

class LivroRepositoryStub(IRepositorioLivro): # Agora ele herda do esqueleto!
    def __init__(self):
